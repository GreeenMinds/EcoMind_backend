...
public class UserRankingQueryServiceImpl implements UserRankingQueryService {
    ...
    @Override
    public List<UserRanking> handle(GetAllUserRankingsQuery query) {
        return userRankingRepository.findAll();
    }

    @Override
    public Optional<UserRanking> handle(GetUserRankingByIdQuery query) {
        return userRankingRepository.findById(query.userRankingId());
    }

    @Override
    public List<UserRanking> handle(GetUserRankingsByRankingIdQuery query) {
