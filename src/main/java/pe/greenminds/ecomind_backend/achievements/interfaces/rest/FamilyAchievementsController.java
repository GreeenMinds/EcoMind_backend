...
import pe.greenminds.ecomind_backend.achievements.application.internal.services.FamilyAchievementEvaluationService;
import pe.greenminds.ecomind_backend.achievements.domain.repositories.AchievementRepository;
import pe.greenminds.ecomind_backend.achievements.interfaces.rest.resources.FamilyAchievementResource;
import pe.greenminds.ecomind_backend.achievements.interfaces.rest.transform.FamilyAchievementResourceFromEntityAssembler;
...
public class FamilyAchievementsController {
    ...
    public ResponseEntity<List<FamilyAchievementResource>> getFamilyAchievements(@PathVariable Long familyId) {
        ...
        var resources = familyAchievements.stream()
                ...
                .toList();
        familyAchievementEvaluationService.markAchievementsAsSeen(familyAchievements);
