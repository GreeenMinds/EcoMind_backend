...
public class CreateActivityUserCommandFromResourceAssembler {
    private CreateActivityUserCommandFromResourceAssembler() {}

    public static CreateActivityUserCommand toCommandFromResource(CreateActivityUserResource resource) {
        return new CreateActivityUserCommand(resource.userId(), resource.activityId());
    }
}
